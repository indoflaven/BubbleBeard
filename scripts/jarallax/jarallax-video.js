...
//ml = 0;
	  ...
	  if(imageData.container.width >= 1200){
		  w=2000;
		  h = 1500;
		  mt = -210;
		  ml = (imageData.container.width - w) / 2;
		  extraFactor = 0;
	  }
	  ...
	  if(imageData.container.width < 992){
		  h = 1250;
		  mt = -200;
		  extraFactor = 50;
	  }
	  
	  if(imageData.container.width < 768){
		  h = 900;
		  mt = -185;
		  extraFactor = 100;
	  }

	  if(imageData.container.width < 576){
		  h = 670;
		  mt = -190;
		  extraFactor = 60;
	  }
...
//alert("jarallaxVideo: " + w + " " + h + " " + " " + ml + " " + (mt + mobileMt))
